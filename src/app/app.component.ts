...
export class AppComponent implements OnInit {
  ...
  pages: Page[] = [
    ...
    new Page(5, 'md-discord', 'Discord',
      { action: () => window.open('https://discord.gg/k7E6WZj', '_system') }),
    new Page(5, 'md-star', 'Rate App',
      { action: () => window.open('market://details?id=com.toxsickproductions.geptv2', '_system') }, !environment.web),
